...
#define ESP1_ON GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_7, GPIO_PIN_7) // aqui estan los defines para que sea mas faciles para poner que se encienda los pines que comunican con la esp
#define ESP1_OFF GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_7, 0)
#define ESP2_ON GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_6, GPIO_PIN_6)
#define ESP2_OFF GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_6, 0)
#define ESP3_ON GPIOPinWrite(GPIO_PORTH_BASE, GPIO_PIN_1, GPIO_PIN_1)
    ...
    while (1)
    {
        ...
        case Inicio_i:
            ...
            if (cancel_m == 1 && segundos > 10)
                ESP1_ON; // Se envia mensaje por whatsapp a adulto*/
            if (cancel_t == 1 && segundos > 10)
                ESP2_ON; // Se envia mensaje por whatsapp a adulto*/
            if (cancel_n == 1 && segundos > 10)
                ESP3_ON; // Se envia mensaje por whatsapp a adulto*/
